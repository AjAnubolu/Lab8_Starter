...
async function getRecipes() {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    for (const url of RECIPE_URLS) {
      // A5. try / catch block for the asynchronous code
      try {
        // A6. Fetch the URL
        ...
        recipes.push(recipe);
        // A9. If we have finished retrieving all of the recipes, save them to
        //     storage and resolve the Promise with the recipes array.
